<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ManagerPageQ.aspx.cs" Inherits="web_pages_ManagerPageQ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1 style="font-size:100px;">questions: (<%=questionCount %>)</h1>
    <h1>
        <%=questionList %>
    </h1>
    <form method="post" action="">
        
        <h1 style="font-size:100px">delete question:</h1>
        <label style="font-size:75px;" for="delete">question's IDNumber:</label><br />
        ...
        <h1>You can't change question's ID</h1>
